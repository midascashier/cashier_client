...
let DebitCardConfirmWithdraw = React.createClass({
	...
	render(){
		...
		return (
			<div id="confirmDebitCard" className="internal-content">
				<div className="row">
										...
										<div className="row">
											<div className="col-sm-12">
												...
												<div className="infoCol text-justify">
													<p>{translate('DEBITCARD_INSTRUCTIONS_PROCESS_INSIDE')}</p>
												</div>
											</div>
										</div>
									</div>
...
module.exports.DebitCardConfirmWithdraw = DebitCardConfirmWithdraw;
