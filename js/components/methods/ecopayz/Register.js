				...
				<form onSubmit={this.addNewPayAccount}>
					<div className="form-group">
						...
						<div className="col-sm-8">
							<Input className="form-control" type="text" id="openPayzNewAccount" name="openPayzNewAccount" ref="account" validate="isString" onChange={this.changeValue} value={this.state.payAccount.account} require/>
						</div>
					</div>
