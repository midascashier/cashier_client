...
let VisaConfirmWithdraw = React.createClass({
  ...
  render(){
    ...
    return (
        <div id="VisaConfirmWithdraw" className="internal-content">
          <div className="row">
                      ...
                      <div className="row">
                        <div className="col-sm-12">
                          ...
                          <div className="infoCol text-justify">
                            <p>{translate('INSTRUCTIONS_PROCESS_INSIDE')}</p>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="col-sm-12">
                          ...
                          <div className="table-responsive">
                            <table className="table table-striped">
                              <tbody>
                              <tr>
                                <td>{translate('CREDIT_CARD_NUMBER', 'Card Number')}</td>
                                <td><span>{payAccount.displayName}</span></td>
                              </tr>
                              <tr>
...
module.exports.VisaConfirmWithdraw = VisaConfirmWithdraw;
