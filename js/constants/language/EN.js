...
let _langTags = {
	...
	WARNING_MINER_DEPOSIT_EXTRA: "Only send <strong>{cryptoName} ({cryptoSymbol})</strong> to this address and ensure you use the corresponding <strong>{extraInfoName}</strong>. Sending any other digital asset or failing to add the <strong>{extraInfoName}</strong> will result in permanent loss.",
	...
	//Processors
  INSTRUCTIONS_PROCESS_INSIDE: "All payouts are processed in the order in which they are received. The average processing time takes between 24 to 72 hours though some cases may take up to 15 business days to process as all requests are subject to extensive review.",
	NETELLER: "Neteller",
	NETELLER_ACCOUNT: "Neteller Account",
	SKRILL_ACCOUNT: "Skrill Account",
	SKRILL_INSTRUCTIONS_PROCESS_INSIDE: "All payouts are processed in the order in which they are received. The average processing time takes between 24 to 72 hours though some cases may take up to 15 business days to process as all requests are subject to extensive review.",
	SELECT_ACCOUNT: "Select your account",
	NETELLER_SECURE: "2FA or Secure ID",
	NETELLER_NEW: "Enter your Neteller Email Account",
	NETELLER_INSTRUCTIONS_PROCESS_INSIDE: "All payouts are processed in the order in which they are received. The average processing time takes between 24 to 72 hours though some cases may take up to 15 business days to process as all requests are subject to extensive review.",
	DEBITCARD_INFO: 'Debit Card Information',
	DEBITCARD_INSTRUCTIONS_PROCESS_INSIDE: "All payouts are processed in the order in which they are received. The average processing time takes between 24 to 72 hours though some cases may take up to 15 business days to process as all requests are subject to extensive review.",
	...
	BITCOIN_INSTRUCTIONS_ADDRESS_INFO: "Include any Miners Fee your wallet charges.",
	...
	GENCK_INSTRUCTIONS_PROCESS_INSIDE: "All payouts are processed in the order in which they are received. The average processing time takes between 24 to 72 hours though some cases may take up to 15 business days to process as all requests are subject to extensive review.",
	...
	ECOPAYZ_WITHDRAWS_PROCESS: "All payouts are processed in the order in which they are received. The average processing time takes between 24 to 72 hours though some cases may take up to 15 business days to process as all requests are subject to extensive review.",
	...
	ONETAB_INSTRUCTIONS_PROCESS_INSIDE: "All payouts are processed in the order in which they are received. The average processing time takes between 24 to 72 hours though some cases may take up to 15 business days to process as all requests are subject to extensive review.",
	...
	CRYPTO_INSTRUCTIONS_ADDRESS_INFO: "Include any Miners Fee your {cryptoCurrency} wallet charges",
