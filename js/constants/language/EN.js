...
let _langTags = {
  ...
  HISTORY_TITLE: 'Here are your last 10 transactions.',
  HISTORY_TABLE_COL_DATE: 'Date',
  HISTORY_TABLE_COL_TYPE: 'Type',
  HISTORY_TABLE_COL_METHOD: 'Method',
  HISTORY_TABLE_COL_AMOUNT: 'Amount',
  HISTORY_TABLE_COL_STATUS: 'Status',
  HISTORY_TABLE_COL_NOTES: 'Notes'
};
