...
let _langTags = {
	...
	// Buy Cryptos
	BUY_CRYPTOS_SELECTCC: "Selecciona tu tarjeta",
	BUY_CRYPTOS_SELECTCC_ADD_NEW: "Agregar nueva tarjeta",
BUY_CRYPTOS_LEYEND: "¿Cuánto deseas comprar?",
BUY_CRYPTOS_REGISTERCC: "Almacenar tarjeta",
BUY_CRYPTOS_CURRENT_BALANCE: "Balance actual",
BUY_CRYPTOS_TITLE_CARD: "Acerca de tu tarjeta:",
BUY_CRYPTOS_TITLE_CARD2: "Acerca de tí:",
BUY_CRYPTOS_BUTTON_BUY: "Comprar",
BUY_CRYPTOS_BUTTON_GETADDRESS: "Obtener dirección",
BUY_CRYPTOS_BUTTON_SAVECC: "Guardar tarjeta",
BUY_CRYPTOS_BUTTON_COPY: "Copiar",
BUY_CRYPTOS_TITLE_COPIED: "¡Copiado!",
BUY_CRYPTOS_BUTTON_RETURN: "Regresar",
BUY_CRYPTOS_TRANSACTION_APPROVED: "Transacción Aprobada",
BUY_CRYPTOS_TRANSACTION_REJECTED: "Transacción Denegada",
BUY_CRYPTOS_TRANSACTION_PENDING: "Transacción Pendiente",
BUY_CRYPTOS_ADDCC_LEYEND: "Por favor agrega una nueva tarjeta",
BUY_CRYPTOS_ADDCC_TEXT: "Para proceder con la compra de bitcoines, es necesario tener al menos una tarjeta VISA almacenada. Por favor agrega una nueva tarjeta antes de continuar.",
BUY_CRYPTOS_DEPOSIT_INFO: "Información del depósito",
BUY_CRYPTOS_FUND_AMOUNT: "Monto del depósito",
BUY_CRYPTOS_SEND_TO: "Enviar a",
BUY_CRYPTOS_AMOUNT: "Monto",
BUY_CRYPTOS_TIME: "¡El tiempo corre!",
BUY_CRYPTOS_HURRY: "¿Porqué la prisa?",
BUY_CRYPTOS_HOVER_FUND_OPTION: 'Carga tu cuenta utilizando el balance disponible.<br/>Balance actual: <strong>{customerBalance} {cryptoCurrencyCode}</strong>',
BUY_CRYPTOS_HOVER_BUY_OPTION: '¿No posees bitcoines? Aquí podrás comprar bitcoines utilizando tu tarjeta VISA. La cantidad de bitcoines disponibles se verán reflejados bajo "Balance actual".<br/>Balance actual: <strong>{customerBalance} {cryptoCurrencyCode}</strong>',
BUY_CRYPTOS_HOVER_DEPOSIT_OPTION: "Deposita en tu cuenta utilizando fondos de un monedero externo.",
BUY_CRYPTOS_HOVER_DEFAULT_OPTION: 'Balance actual: <strong>{customerBalance} {cryptoCurrencyCode}</strong>',
BUY_CRYPTOS_TITLE_AMOUNT: 'Monto del depósito',
BUY_CRYPTOS_TITLE_AVAILABLE: 'Disponible',
BUY_CRYPTOS_BTN_DEPOSIT_WITH: "Deposita con {cryptoCurrencyName}",
BUY_CRYPTOS_INSUFFICIENT_FOUND: 'Balance en bitcoines no es suficiente',
BUY_CRYPTOS_MIN_MAX_LIMITS: 'Por favor ingresa un monto válido',
BUY_CRYPTOS_TOOLTIP_CRONO: "El precio de esta transacción en en bitcoines es válida por 15 minutos. Después de eso, el precio puede variar, lo que causaría que recibas un monto diferente al esperado. Tus fondos deben estar disponibles en 30 minutos posterior a realizar la transferencia desde tu monedero.",
BUY_CRYPTOS_TRY_AGAIN: "Intenta de nuevo",
BUY_CRYPTOS_ERROR_TEXT: 'Algo salió mal. Ya hemos tomado nota del problema; mientras tanto... Por favor haz clic en "Intentar de nuevo" para generar una nueva dirección y código QR.',
BUY_CRYPTOS_PROMOCODE: "Ingresa un código promocional",
BUY_CRYPTO_MIN_LIMIT: "Por favor, incrementa el monto e intenta de nuevo",
BUY_CRYPTO_MAX_LIMIT: "Por favor, reduce el monto e intenta de nuevo",
BUY_CRYPTO_TICKET_APPROVED: 'Transacción Aprobada',
BUY_CRYPTO_TICKET_REJECTED: 'Transacción Denegada',
BUY_CRYPTO_CARDHOLDER_NAME: "El nombre del tarjetahabiente debe ser idéntico al provisto en la sección \"Acerca de tí\".",

// Wallet
WALLET: 'Monedero',
WALLET_BUY_TRANSACTION_TITLE: 'Historial de compras de Bitcoines',
WALLET_PENDING_TRANSACTION_TITLE: 'Depósitos en Bitcoines pendientes',
WALLET_TAB_PURCHASES: 'Compras de Bitcoines',
WALLET_TAB_PENDING_DEPOSITS: 'Depósitos Pendientes',
WALLET_BUY_TRANSACTION_TABLE_COL_STATUS: 'Estado',
WALLET_BUY_TRANSACTION_TABLE_COL_CC: 'Tarjeta',
WALLET_BUY_TRANSACTION_TABLE_COL_DETAILS: 'Detalles',
WALLET_BUY_TRANSACTION_TABLE_COL_DATE: 'Fecha',
WALLET_BUY_NO_RECORDS: 'No se encontraron registros',
WALLET_BITCOIN_BALANCE: 'Balance de Bitcoines',
WALLET_BUTTON_COMPLETE_DEPOSIT: 'Completar Depósito'
