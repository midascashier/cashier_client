...
let _langTags = {
  ...
  HISTORY_TITLE: 'Aquí están sus últimas 10 transacciones.',
  HISTORY_TABLE_COL_DATE: 'Fecha',
  HISTORY_TABLE_COL_TYPE: 'Tipo',
  HISTORY_TABLE_COL_METHOD: 'Método',
  HISTORY_TABLE_COL_AMOUNT: 'Monto',
  HISTORY_TABLE_COL_STATUS: 'Estado',
  HISTORY_TABLE_COL_NOTES: 'Mensaje'
};
