...
let _langTags = {
	...
	// Buy Cryptos
	BUY_CRYPTOS_SELECTCC: "Selecciona tu tarjeta de crédito",
	BUY_CRYPTOS_SELECTCC_ADD_NEW: "Registar nueva tarjeta de crédito",
	BUY_CRYPTOS_LEYEND: "Cuánto quieres comprar?",
	BUY_CRYPTOS_REGISTERCC: "Registar nueva tarjeta de crédito",
	BUY_CRYPTOS_CURRENT_BALANCE: "Balance disponible",
	...
	BUY_CRYPTOS_BUTTON_SAVECC: "Guardar",
	...
	BUY_CRYPTOS_TRANSACTION_REJECTED: "Transacción rechazada",
	BUY_CRYPTOS_TRANSACTION_PENDING: "Transacción pendiente",
	BUY_CRYPTOS_ADDCC_LEYEND: "Por favor ingrese una nueva tarjeta de crédito",
	BUY_CRYPTOS_ADDCC_TEXT: "In order to buy bitcoins, you must have a VISA card on file. Please add one before processing.",
	BUY_CRYPTOS_DEPOSIT_INFO: "Información de depósito",
	BUY_CRYPTOS_FUND_AMOUNT: "Monto a depositar",
	BUY_CRYPTOS_SEND_TO: "Enviar a:",
	BUY_CRYPTOS_AMOUNT: "Monto:",
	BUY_CRYPTOS_TIME: "Tiempo restante!",
	BUY_CRYPTOS_HURRY: "Why  the hurry?",
	BUY_CRYPTOS_HOVER_FUND_OPTION: 'Fund your account using available balance.<br/>Available balance: <strong>{customerBalance} {cryptoCurrencyCode}</strong>',
	BUY_CRYPTOS_HOVER_BUY_OPTION: 'Here you can purchase bitcoins using your VISA card if you don\'t have any at all. These will be reflected under "available balance".<br/>Available balance: <strong>{customerBalance} {cryptoCurrencyCode}</strong>',
	BUY_CRYPTOS_HOVER_DEPOSIT_OPTION: "Deposit using funds from an external wallet.",
	BUY_CRYPTOS_HOVER_DEFAULT_OPTION: 'Balance disponible: <strong>{customerBalance} {cryptoCurrencyCode}</strong>',
	BUY_CRYPTOS_TITLE_AMOUNT: 'Monto a depositar',
	BUY_CRYPTOS_TITLE_AVAILABLE: 'Disponible',
	BUY_CRYPTOS_BTN_DEPOSIT_WITH: 'Depositar con {cryptoCurrencyName}',
	BUY_CRYPTOS_INSUFFICIENT_FOUND: 'Balance en crypto insuficiente',
	BUY_CRYPTOS_MIN_MAX_LIMITS: 'Por favor ingrese un monto válido',
	...
	BUY_CRYPTOS_TRY_AGAIN: "Intentar de nuevo",
	...
	BUY_CRYPTOS_PROMOCODE: "Ingresa tu promocode",
	BUY_CRYPTO_MIN_LIMIT: "Por favor incremente el monto e intente de nuevo",
	BUY_CRYPTO_MAX_LIMIT: "Por favor disminuya el monto e intente de nuevo",
	BUY_CRYPTO_TICKET_APPROVED: 'Transacción aprobada.',
	BUY_CRYPTO_TICKET_REJECTED: 'Transacción rechazada.',
	BUY_CRYPTO_CARDHOLDER_NAME: "Cardholder's name must match the one provided in the \"About You\" section.",

	// Wallet
	WALLET: 'Wallet',
	WALLET_BUY_TRANSACTION_TITLE: 'Historial de compras en bitcoin',
	WALLET_PENDING_TRANSACTION_TITLE: 'Depósitos pendientes de bitcoin',
	WALLET_TAB_PURCHASES: 'Compras de bitcoin',
	WALLET_TAB_PENDING_DEPOSITS: 'Depósitos pendientes',
	WALLET_BUY_TRANSACTION_TABLE_COL_STATUS: 'Estado',
	WALLET_BUY_TRANSACTION_TABLE_COL_CC: 'Tarjeta de crédito',
	WALLET_BUY_TRANSACTION_TABLE_COL_DETAILS: 'Detalles',
	WALLET_BUY_TRANSACTION_TABLE_COL_DATE: 'Fecha',
	WALLET_BUY_NO_RECORDS: "No hay registros!",
	WALLET_BITCOIN_BALANCE: 'Balance en bitcoin',
