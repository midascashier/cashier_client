...
let _langTags = {
	...
	TRANSACTION_HISTORY_STATUS_PENDING: "Tu solicitud de retiro se encuentra en cola de revisión.",
	TRANSACTION_HISTORY_STATUS_DEFERRED: "Pending verify information.",
	TRANSACTION_HISTORY_STATUS_PROCESSING: "Tu solicitud se encuentra en proceso de ser paga.",
	TRANSACTION_HISTORY_STATUS_PRE_APPROVE: "A la espera de comprobar la información.",
	TRANSACTION_HISTORY_STATUS_APPROVED: "Tu solicitud de retiro fue aprobada y el pago se estará realizando pronto.",
	TRANSACTION_HISTORY_STATUS_REJECTED: "Por favor verifique la información.",
	TRANSACTION_HISTORY_STATUS_CANCELLED: "Tu solicitud de retiro fue cancelada, por favor revisa tu correo electrónico para más detalles.",
	TRANSACTION_HISTORY_STATUS_FAILED: "Por favor contactenos para más información.",
	TRANSACTION_HISTORY_STATUS_REJECTED_AND_FAILED: "Un error no nos permitió procesar tu pago, por favor contáctanos para más detalles.",
